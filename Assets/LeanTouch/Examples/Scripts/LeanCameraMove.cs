...
namespace Lean.Touch
{
	...
	public class LeanCameraMove : MonoBehaviour
	{
		...
		protected virtual void LateUpdate()
		{
			...
			// ajc need to adjust sensitivity dynamically with cam distance from model origin.
			var camDistance = Vector3.Distance(this.transform.localPosition, this.transform.GetChild(0).transform.localPosition);
			Sensitivity =  camDistance / 84;
